...
$query = mysqli_query($conn, "SELECT * FROM tb_masuk LEFT JOIN tb_kat_pupuk ON tb_kat_pupuk.id_kat_pupuk = tb_masuk.kategori");
while ($record = mysqli_fetch_array($query)) {
    $result[] = $record;
}

$select_kat_pupuk = mysqli_query($conn, "SELECT id_kat_pupuk,kategori_pupuk FROM tb_kat_pupuk");
?> 
                            ...
                            <div class="modal-body">
                                <form class="needs-validation" novalidate action="proses/proses_input_pupuk.php" method="POST" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-floating mb-3">
                                                <input disabled type="text" class="form-control" id="floatingInput" value="<?php echo $row['nama'] ?>">
                                                <label for="floatingInput">Nama Pupuk</label>
                                                <div class="invalid-feedback">
                                                    Masukkan Nama Pupuk.
                                                </div>
                            ...
                            <div class="modal-body">
                                <form class="needs-validation" novalidate action="proses/proses_edit_pupuk.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control" id="floatingInput" placeholder="nama pupuk" name="nama_pupuk" required value="<?php echo $row['nama'] ?>">
                                                <label for="floatingInput">Nama Pupuk</label>
                                                <div class="invalid-feedback">
                                                    Masukkkan Nama Pupuk.
                                                </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class="needs-validation" novalidate action="proses/proses_delete_pupuk.php" method="POST">
                                    ...
                                    <div class="col-lg-12">
                                        Apakah anda inggin menghapus data pupuk ini <b><?php echo $row['nama'] ?></b>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo ($row['jenis_pupuk'] == 1) ? "Makanan" : "Minuman" ?></td>
