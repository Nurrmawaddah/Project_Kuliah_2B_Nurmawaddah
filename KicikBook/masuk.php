                            ...
                            <div class="modal-body">
                                <form class="needs-validation" novalidate action="proses/proses_input_pupuk.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="form-floating mb-3">
                                                <input disabled type="number" class="form-control" id="floatingInput" placeholder="stok" value="<?php echo $row['jumlah'] ?>">
                                                <label for="floatingInput">Stok</label>
                                                <div class="invalid-feedback">
                                                    Jumlah Stok Pupuk.
                                                </div>
                            ...
                            <div class="modal-body">
                                <form class="needs-validation" novalidate action="proses/proses_edit_pupuk.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="form-floating mb-3">
                                                <input type="number" class="form-control" id="floatingInput" placeholder="stok" name="stok" required value="<?php echo $row['jumlah'] ?>">
                                                <label for="floatingInput">Stok</label>
                                                <div class="invalid-feedback">
                                                    Masukkan Stok Pupuk.
                                                </div>
