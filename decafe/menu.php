                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="input-group mb-3">
                                            <input type="file" class="form-control py-3" id="uploadgambar" placeholder="Your Name" name="gambar" required>
                                            <label class="input-group-text" for="uploadgambar">Upload Gambar Menu</label>
                                            <div class="invalid-feedback">
                                                Masukkan File Gambar Menu.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <div class="d-flex">
                                            ...
                                            <button class="btn btn-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#ModalResetPassword<?php echo $row['id'] ?>"><i class="bi bi-arrow-counterclockwise"></i></button>
                                        </div>
