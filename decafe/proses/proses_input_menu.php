    ...
    window.location="../menu"</script>
        ...
        window.location="../menu"</script>';
            ...
            if (move_uploaded_file($_FILES['foto']['tmp_name'], $target_file)) {
                $query = mysqli_query($conn, "INSERT INTO tb_daftar_menu (foto,nama_menu,keterangan,kategori,harga,stok)values('" . $kode_rand . $_FILES['foto']['names'] . "','$nama_menu','$keterangan','$kat_menu','$harga','$stok')");
                if ($query) {
